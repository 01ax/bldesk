...
Not yet run for this branch: a physical Android device. The desktop rows above are the shared-component evidence; the Android rows in the table are source audits, and the device pass is recorded separately when complete.
