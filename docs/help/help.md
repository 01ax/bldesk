---
title: Using help
summary: Search BLDesk documentation and ask questions about BinaryLane articles.
keywords: [search, articles, suggestions, offline, feedback]
---
...
Local help is bundled with this app version. The help service searches BinaryLane articles, not these local pages or your account.

## Privacy and offline use
Only search-box text is sent for questions and suggestions. Keep account details out of it. The last five explicitly submitted searches are stored on this device; answers and conversations are not saved. See [what Ask BinaryLane can see](help:troubleshooting#what-ask-binarylane-can-see).

If the service is unavailable, your local search results remain usable. Clear the box to return to the topic index. A page's outline jumps to its headings.
